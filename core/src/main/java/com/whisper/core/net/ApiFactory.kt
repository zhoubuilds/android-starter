...
import com.whisper.core.net.annotation.BaseUrl
import com.whisper.core.net.annotation.Interceptors
...
object ApiFactory {
    ...
    private val API_CACHE: MutableMap<Class<*>, Any> = ConcurrentHashMap()

    @Suppress("UNCHECKED_CAST")
    fun <T : Any> create(clazz: Class<T>): T {
        return API_CACHE[clazz] as? T ?: synchronized(this) {
            API_CACHE[clazz] as? T ?: buildApi(clazz).also { API_CACHE[clazz] = it }
        }
    }
